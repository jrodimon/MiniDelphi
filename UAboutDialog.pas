...
begin
  ...
  begin
    ...
    try
      ...
      Add('  * Six tabs: Compiler, Calculator, Learn Delphi, Projects,');
      Add('    Forms, Macros');
      Add('  * Snippet insert menu (right-click in any editor)');
      ...
      Add('  * Project save/load with .mdproj projects and .mdp libraries');
      Add('  * Visual form builder (Phase 1) -- design .mdfrm forms');
      Add('  * Macros tab for project-local scripts');
      Add('  * Themed UI: Dark, Light, or Follow Windows');
...
begin
  ...
  begin
    ...
    try
      ...
      Add('---------------------------------');
      Add('');
      Add('In any code editor (Compiler tab or Projects tab):');
      Add('');
      Add('  * Right-click in the editor -- snippet menu pops at cursor');
      Add('  * Or type a trigger keyword + Tab to expand it inline:');
      Add('');
      Add('       if + Tab       -> if .. then');
      ...
      Add('');
      Add('File menu shortcuts (any tab):');
      Add('');
      Add('  Ctrl+N      New file');
      Add('  Ctrl+O      Open file');
      Add('  Ctrl+S      Save current file');
      Add('  Ctrl+F11    View Project Source');
      Add('  F5          Run');
      Add('  Alt+F4      Exit');
      Add('');
      Add('');
      ...
      Add('18. FORM BUILDER (Phase 1)');
      Add('--------------------------');
      Add('');
      Add('The Forms tab is a visual designer for .mdfrm files. Each form');
      Add('belongs to the currently-open project. Use File > New Form or');
      Add('the New button on the Forms toolbar to start.');
      Add('');
      Add('Layout');
      Add('');
      Add('  [Forms in Project] [Palette] [Design surface] [Object Inspector]');
      Add('');
      Add('Designing');
      Add('');
      Add('  * Click a palette tool (Label, Button, Edit) then click the');
      Add('    design surface to place that control.');
      Add('  * Click "Pointer" to return to selection mode.');
      Add('  * Click a placed control to select it.');
      Add('  * Drag to move; arrow keys nudge by 1px; Delete removes.');
      Add('  * Click empty form area to select the form itself.');
      Add('');
      Add('Object Inspector properties');
      Add('');
      Add('  Form:     Name, Caption, Width, Height');
      Add('  Control:  Name, Type, Left, Top, Width, Height, Caption,');
      Add('            Text (Edit only), OnClick (Button)');
      Add('');
      Add('The Name must be a valid identifier and unique within the form.');
      Add('OnClick stores a handler procedure name; Phase 2 will wire that');
      Add('to actual button clicks. In Phase 1 the runtime shows the form');
      Add('but buttons do not yet invoke handlers.');
      Add('');
      Add('Saving');
      Add('');
      Add('  Save / Save As writes a .mdfrm file. The format is INI-style:');
      Add('');
      Add('     [Form]');
      Add('     Name=GreetingForm');
      Add('     Caption=Greeting');
      Add('     Width=400');
      Add('     Height=200');
      Add('');
      Add('     [Control:Label1]');
      ...
      Add('     Left=20');
      Add('     Top=20');
      Add('     Caption=Enter your name:');
      Add('');
      Add('     [Control:BtnGreet]');
      Add('     Type=Button');
      Add('     Left=20');
      Add('     Top=90');
      Add('     Caption=Greet me!');
      Add('     OnClick=OnGreetClick');
      Add('');
      Add('Runtime (Phase 1)');
      Add('');
      Add('  Forms display modally with real VCL controls. Edits accept');
      Add('  typing; buttons are inert until Phase 2 adds event wiring.');
      Add('');
      Add('');
      ...
      Add('----------');
      Add('');
      Add('The Macros tab holds small scripts intended to run against the');
      Add('current project or the user''s computer. Each macro has:');
      Add('');
      ...
      Add('on IDE startup. A handful of starter macros are seeded on first');
      Add('run.');
      Add('');
      Add('');

      Add('20. THEMES AND PREFERENCES');
      Add('--------------------------');
      Add('');
      Add('Open View > Preferences... to choose between three appearance');
      Add('modes:');
      Add('');
      Add('  * Dark   -- Carbon style');
      Add('  * Light  -- Iceberg Classico style');
      ...
      Add('Classico must be enabled in the project at build time');
      Add('(Project > Options > Application > Appearance) to be available');
      Add('at runtime.');
      Add('');
      Add('');
